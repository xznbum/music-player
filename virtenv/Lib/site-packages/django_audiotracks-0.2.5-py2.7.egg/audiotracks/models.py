...
class Artist(models.Model):
    name = models.CharField("Исполнитель", max_length=200, null=True)
...
class Genre(models.Model):
    name = models.CharField("Жанр", max_length=200, null=True)
...
class Playlist(models.Model):
    user = models.OneToOneField(User, verbose_name="Пользователь", related_name="playlists", null=True)
    name = models.CharField("Название", max_length=200, null=True, blank=True)
    tracks = models.ManyToManyField(Track, verbose_name="Треки", related_name="playlists", blank=True, null=True)
...
class Comment(models.Model):
    created_at = models.DateTimeField(auto_now_add=True)
    user = models.ForeignKey(User, verbose_name="Пользователь", related_name="comments", null=True)
    track = models.ForeignKey(Track, verbose_name="Трек", related_name="comments", null=True)
...
class Like(models.Model):
    user = models.ForeignKey(User, verbose_name="Пользователь", related_name="likes", null=True)
    track = models.ForeignKey(Track, verbose_name="Трек", related_name="likes", null=True)