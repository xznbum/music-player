...
class Artist(models.Model):
    name = models.CharField("Artist", max_length=200, null=True, blank=True)
...
class Genre(models.Model):
    name = models.CharField("Genre", max_length=200, null=True, blank=True)
...
class AbstractTrack(models.Model):
    ...
    genre = models.ForeignKey(Genre, related_name="tracks", blank=True, null=True)
...
class Playlist(models.Model):
    user = models.ForeignKey(User, related_name="playlists", blank=True, null=True)
...
class Comment(models.Model):
    ...
    track = models.ForeignKey(Track, related_name="comments", blank=True, null=True)
